...
#' @param clustering function; a clustering function which will be applied to the projection vectors
#' @param ... additional arguments which will be passed on to the \code{clustering} function
#'
#' @return if no clustering algorithm is passed: a matrix containing the optimal \code{k}-dimensional projections of the input vectors as its columns, otherwise: the original data with clustering information generated by the passed \code{clustering} funtcion.
#' @examples
#'# X <- generate_nested_2d_training_data(400)
