...
plot(0,0, pch=1, cex=15, main="Example of a Core-distance", cex.axis=.75)
#points(0,0, pch=1, cex=30)
segments(0, 0, .5, 0, lwd=2)
text(.225, 0.075, "epsilon", cex=.75)
