...
The DBSCAN algorithm searches for objects which contain a certain amount of objects in a given radius. The radius, called the neighborhood, and the expected number of neighboring objects are specified as arguments.
...
plot(0,0, pch=1, cex=15, xaxt='n', yaxt='n', main="Example of a Neighborhood")
...
clustering::plot_clustered_2d_data(DBSCAN(x, .1, 7), hide_axis_text=TRUE);
```
...
plot2d(X, title=NULL,xlabel="", ylabel="")
