...
<!-- markdown and knitr -->
`R` markdown, especially in combination with **knitr**, offered us a convenient way to create all documents which are part of this project, namely the two Vignettes, the presentation, and this report itself. The integration of those features into RStudio is seamless and offers neat features, e.g. the execution of `R` snippets in place which is significantly faster than rendering the entire document to check on every change.
