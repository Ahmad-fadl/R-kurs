...
- 4 if new means = old means then we are done we have our      clusters, otherwise go back to 2.
...
- algorithm does generated projections of input vectors
...
- The distance metric: single, complete, average, median cab used to to group objects into clusters.
